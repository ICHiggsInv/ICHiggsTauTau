#ifndef EventShapeAxis_h
#define EventShapeAxis_h

/*  \class EventShapeAxis
*
*  Class that, given the a TAxisvector of the input objects in the event, 
...
public:
  ...
  //TLorentzvectors and a chosen Axis to calculate
  //Event-Shape Variables - central variables 
  //are calculated out of central objects only
  //
  ...
  EventShapeAxis(std::vector< TLorentzVector >& PtEtaPhiE_vector,std::vector<float> eventAxis,float eta_central,  int rapidity);
...
//12. exponentially suppressed forward term (calculated by non-central objects)
//13. recoil term (calculated by central objects)
//=============================================================================
